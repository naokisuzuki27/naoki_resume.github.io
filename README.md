...
|生命保険代理店会社ホームページのCloudFormationでのインフラ構築対応|2024/7〜2024/10|メンバー(インフラ3名)|AWS|・AWSインフラ基盤の設計・構築<br>・CloudFormationコードの開発|
|Wordpress(EC2)投稿データのRDSへの移行|2024/7〜2024/8|メンバー(インフラ1名)|AWS|・EC2(Wordpress)投稿データをRDS for MySQLへ移行|
