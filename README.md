...
クラウド事業本部(クラウドエンジニア) 
#### 主なプロジェクト
|プロジェクト|期間|担当|インフラ環境|主な業務内容|
|---|-----|-----|-----|-----|
|大手損害保険会社にてAWS基盤のOSverUP自動化対応|2024/7〜2025/3|メンバー(インフラ6名)|AWS|・Ansibleを使用したOS設定の自動化対応<br>・新規EC2構築によるインフラ構成の変更<br>・Rubyを活用したOS設定テスト|
|生命保険代理店会社HPのCloudFormationでのインフラ構築対応|2024/7〜2024/10|メンバー(インフラ3名)|AWS|・AWSインフラ基盤の設計・構築<br>・CloudFormationコードの開発|
|自社ブログのWordpress(EC2)投稿データのRDSへの移行|2024/7〜2024/8|メンバー(インフラ1名)|AWS|・EC2(Wordpress)投稿データをRDS for MySQLへ移行|
